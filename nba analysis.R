...
#Players
Players <-c("KobeBryant","JoeJohnson","LeBronJames","CarmeloAnthony","DwightHoward","ChrisBosh","ChrisPa
ul","KevinDurant","DerrickRose","DwayneWade")
...
#Matrix
Games <- rbind(KobeBryant_G, JoeJohnson_G, LeBronJames_G, CarmeloAnthony_G, DwightHoward_G,
...
matplot(t(Games),type="b",pch=15:18,col=c(1:4,6))
legend("bottomleft",inset=0.05,legend=Players,col=c(1:4,6),horiz=F,,pch=15:18)
